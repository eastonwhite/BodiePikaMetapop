...
radius_vector=seq(50,1500,by=10)
...
trial_trial_mean=matrix(0,nrow=1,ncol=length(u_vector)) #mean population size
trial_trial_mean_sd=matrix(0,nrow=1,ncol=length(u_vector)) #sd of population size
trial_trial_variance= matrix(0,nrow=1,ncol=length(u_vector)) #variance in pop size
trial_trial_ext_year=matrix(0,nrow=1,ncol=length(u_vector)) # year of southern extinction
trial_trial_occupancy=matrix(0,nrow=1,ncol=length(u_vector)) #patch occupancy
trial_trial_occupancy_sd=matrix(0,nrow=1,ncol=length(u_vector))
trial_trial_ext_events=matrix(0,nrow=1,ncol=length(u_vector)) #number of extinction events
trial_trial_recol_events=matrix(0,nrow=1,ncol=length(u_vector)) #number of recolonization events
trial_trial_error=matrix(0,nrow=1,ncol=length(u_vector)) #error between simulation and field
...
save(IC,trials,u_vector,trial_trial_mean,trial_trial_mean_sd,trial_trial_variance,trial_trial_ext_year,trial_trial_occupancy,trial_trial_occupancy_sd,trial_trial_ext_events,trial_trial_recol_events,trial_trial_error,file='ParameterSensitivity_100trials_u.Rdata')
