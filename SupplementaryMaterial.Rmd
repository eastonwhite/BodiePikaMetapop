...
1. Inverse pattern-orientated estimation procedure
2. Effects of spatial structure and patch heterogeneity
...
We used our simulation model and an inverse pattern-orientated approach to estimate disperser mortality probability [citations]. Essentially, we ran our simulation model with different dispersal mortality probabilities and compared model outputs to census data. Here is a more detailed explanation of our approach:
